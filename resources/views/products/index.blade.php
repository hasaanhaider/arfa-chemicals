    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <h6 class="mb-4 text-15">Products</h6>
                <table id="basic_tables" class="display stripe group" style="width:100%">
                    <thead>
                        <tr>
                            <th class="ltr:!text-left rtl:!text-right">Product Name</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form class="d-block" action="{{ route('product.destroy', $product->id) }}" method="POST"
